...
public class MemberController {
	...
	public boolean memberIdCheck(@RequestParam(name = "memberId",required = false)String memberId
		...
		//idCheck 중복된 아이디 있는 경우에는 false
		Member member = memberService.getMemberInfoById(memberId);
		if(member != null) idCheck = false;
		
		return idCheck;
		//@ResponseBody를  붙여서 사용하게되면  화면에 문자열로 출력됨
	}
	...
	public String login(Model model
		...
		//loginResult가 null이 아니라면 ${loginResult}값을 보여줘라  
		//즉  PostMapping에  reAttr.addAttribut("loginResult","등록된회원이없습니다") 라는 값을 가진 것을 보여줘야한다 
		//loginResult null이라면 그값을 보여주지말라는뜻도 있다.
		return "login/login";
	}
	...
	public String removeMember(@RequestParam(value="memberId", required = false) String memberId
		...
		log.info("=================================");
		log.info("화면에서 입력받은값(회원탈퇴)memberId:{}",memberId);
		log.info("화면에서 입력받은값(회원탈퇴)memberPw:{}",memberPw);
		log.info("=================================");
		//System.out.println("========================================");
	...
	public String modifyMember(Member member) {
		log.info("=================================");
		log.info("화면에서 입력받은값(회원탈퇴)member:{}",member);
		log.info("=================================");
		//System.out.println("========================================");
	...
	public String addMember(Member member) {
		log.info("=================================");
		log.info("화면에서 입력받은값(회원가입)member:{}",member);
		log.info("=================================");
